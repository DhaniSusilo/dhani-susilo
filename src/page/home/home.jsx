...
import { Reveal } from "../../minicomp/stylecomp";
  ...
  return (
    ...
    >
      <div className="w-full h-full sm:w-3/4 sm:items-start judul font-jost font-bold text-[20vh] xl:text-[15vw] text-white flex flex-col justify-center">
        <div className="z-0 sm:ml-20 lg:ml-40 lg:left-0">
          <Reveal>DEV</Reveal>
        </div>
        <div className="z-10 ml-10 sm:ml-40 lg:ml-72">
          <Reveal>ELO</Reveal>
        </div>
        <div className="z-20 sm:ml-32 lg:ml-96">
          <Reveal>PER</Reveal>
        </div>
      </div>
